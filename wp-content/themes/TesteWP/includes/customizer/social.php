...
function ju_social_customizer_section($wp_customize)
{
  ...
  $wp_customize->add_control(
    new WP_Customize_Control(
      ...
      array(
        'label'          => __('Facebook Handle', 'teste wp'),
  ...
  $wp_customize->add_control(
    new WP_Customize_Control(
      $wp_customize,
      'ju_twitter_handle_input',
      array(
        'label'          => __('Twitter Handle', 'teste wp'),
        'section'        => 'ju_social_section',
  ...
  $wp_customize->add_control(
    new WP_Customize_Control(
      ...
      array(
        'label'          => __('Instagram Handle', 'teste wp'),
        'section'        => 'ju_social_section',
  ...
  $wp_customize->add_control(
    new WP_Customize_Control(
      ...
      array(
        'label'          => __('Email Handle', 'teste wp'),
        'section'        => 'ju_social_section',
  ...
  $wp_customize->add_control(
    new WP_Customize_Control(
      ...
      array(
        'label'          => __('Phone Handle', 'teste wp'),
        'section'        => 'ju_social_section',
